...
**Next steps**:
  - Run __SPECKIT_COMMAND_PLAN__ <feature> for detailed planning
  - Run __SPECKIT_COMMAND_SCAFFOLD_ROUTE__ <feature-kebab> to add/update route segments
  - Run __SPECKIT_COMMAND_AUDIT__ to verify compliance
```
